...
<#
.SYNOPSIS
Read-only validation of AVD Workspace diagnostics, category coverage and destination.
.EXAMPLE
...
$resource = $AVDWorkspaceResourceId.TrimEnd('/')
$baseline = @('Checkpoint','Error','Management','Feed')
